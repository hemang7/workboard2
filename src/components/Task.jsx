...
const Task = ({ allData, id, index, boardId, userId, columnDetails, filterBy, projectId }) => {
    ...
    return (
        <div className={`${matched ? '' : 'opacity-10'}`}>
        	...
        	<Modal modal={modal} setModal={setModal} ariaText='Task Details'>
        		<TaskDetails taskDetails={theTask} closeModal={()=>setModal(false)} boardId={boardId} userId={userId} columnDetails={columnDetails} projectId={projectId} />
        	</Modal> 
