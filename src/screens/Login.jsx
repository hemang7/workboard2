		...
		<>
			<div className='bg-gradient-to-r from-indigo-50 via-blue-50 to-red-50 flex flex-col-reverse md:flex-row md:justify-between px-5 md:px-20 py-12 md:py-24 h-screen'>
				<div className='w-full md:w-7/12 md:pr-12 pt-4'>
					<h1 className='text-3xl md:text-5xl text-gray-800 text-primary'>WorkBoard</h1>
					<p className='mt-3 md:mt-6 text-base md:text-xl text-gray-600 leading-normal'>A simplified project management tool for organizing tasks.</p>
