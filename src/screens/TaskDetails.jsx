...
const TaskDetails = ({taskDetails, boardId, userId, columnDetails, closeModal, projectId}) => {
...
{/* First column */}
					<div className="col-span-6 mt-12">
						...
						<div>
							...
							<Checklist todos={taskDetails.todos} taskId={taskDetails.id} boardId={boardId} userId={userId} projectId = {projectId} />
						</div>
